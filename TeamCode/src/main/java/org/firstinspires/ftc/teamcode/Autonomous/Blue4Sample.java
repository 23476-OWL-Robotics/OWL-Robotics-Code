...
/*
    Autonomous Program for the Blue Alliance
    Scores 39 points
*/
@Autonomous
public class Blue4Sample extends LinearOpMode {

    @Override
    public void runOpMode() {

        // Create drive, arm, and intake for rr, arm functions, and intake functions.
        MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(-8.5, 62, Math.toRadians(0)));
        ...
        Pose2d action6Pose = new Pose2d(56, 56, Math.toRadians(45));
        Pose2d action7Pose = new Pose2d(58, 44, Math.toRadians(90));
        Pose2d action8Pose = new Pose2d(56, 56, Math.toRadians(45));
        Pose2d action9Pose = new Pose2d(54, 40, Math.toRadians(135));
        Pose2d action10Pose = new Pose2d(56, 56, Math.toRadians(45));
