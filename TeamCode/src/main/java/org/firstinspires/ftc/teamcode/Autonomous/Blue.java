...
public class Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d action1Pose = new Pose2d(16.5, 62, Math.toRadians(0));
        Pose2d action2Pose = new Pose2d(10.5, 29, Math.toRadians(-90));
        Pose2d action3Pose = new Pose2d(49, 44, Math.toRadians(90));
        Pose2d action4Pose = new Pose2d(58, 58, Math.toRadians(45));
        Pose2d action5Pose = new Pose2d(58, 44, Math.toRadians(90));
        Pose2d action8Pose = new Pose2d(58, 58, Math.toRadians(45));

        Pose2d basketActionPose = new Pose2d(55, 55, Math.toRadians(45));
        ...
        Action action2 = drive.actionBuilder(action2Pose)
                ...
                .splineToLinearHeading(new Pose2d(49, 44, Math.toRadians(90)), Math.toRadians(0))
                .build();
