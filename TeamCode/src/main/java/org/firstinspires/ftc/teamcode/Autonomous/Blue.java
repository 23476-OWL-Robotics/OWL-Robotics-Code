...
public class Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d action4Pose = new Pose2d(55, 55, Math.toRadians(45));
        Pose2d action5Pose = new Pose2d(48, 48, Math.toRadians(90));
        Pose2d action6Pose = new Pose2d(55, 55, Math.toRadians(45));
        Pose2d action7Pose = new Pose2d(58, 47, Math.toRadians(90));
        Pose2d action8Pose = new Pose2d(55, 55, Math.toRadians(45));
        Pose2d action9Pose = new Pose2d(54, 40, Math.toRadians(135));
        Pose2d action10Pose = new Pose2d(55, 55, Math.toRadians(45));
        ...
        Action action4 = drive.actionBuilder(action4Pose)
                ...
                .splineToLinearHeading(new Pose2d(48, 48, Math.toRadians(90)), Math.toRadians(-135))
                .build();
