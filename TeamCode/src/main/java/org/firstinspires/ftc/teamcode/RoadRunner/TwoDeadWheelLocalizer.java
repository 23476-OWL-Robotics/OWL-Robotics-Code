...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1376.0105935213783; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1867.7659964074664; // x position of the perpendicular encoder (in tick units)
    }
