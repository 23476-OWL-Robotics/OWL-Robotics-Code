...
@Autonomous
public class Blue3Sample extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d action7Pose = new Pose2d(54, 40, Math.toRadians(135));
        ...
        Action action2 = drive.actionBuilder(action2Pose)
                ...
                .splineToLinearHeading(new Pose2d(48, 44, Math.toRadians(90)), Math.toRadians(0))
                .build();
