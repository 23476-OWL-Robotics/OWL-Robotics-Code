    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                slide_control(gamepad2.right_stick_y, -gamepad2.left_stick_y, 0.2);
                blue_intake_control(gamepad2.right_trigger, gamepad2.left_trigger, gamepad2.dpad_left, gamepad2.dpad_right, gamepad2.touchpad, 0.1);
                output_control(gamepad2.y, gamepad2.a);
                specimen_control(gamepad2.x, gamepad2.b);
                motor_power_sets(gamepad1.right_bumper);
                telemetry();
            }
        }
    }
